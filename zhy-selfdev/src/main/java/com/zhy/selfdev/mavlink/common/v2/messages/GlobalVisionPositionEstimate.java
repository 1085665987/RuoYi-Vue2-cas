...
public class GlobalVisionPositionEstimate implements Message {
	...
	public GlobalVisionPositionEstimate(BigInteger usec, float x, float y, float z, float roll, float pitch, float yaw, float[] covariance, short resetCounter) {
		this.usec = usec;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public final GlobalVisionPositionEstimate setCovariance(float[] covariance) {
		this.covariance = covariance;
		return this;
	}
	...
	public final GlobalVisionPositionEstimate setResetCounter(short resetCounter) {
		this.resetCounter = resetCounter;
		return this;
	}
