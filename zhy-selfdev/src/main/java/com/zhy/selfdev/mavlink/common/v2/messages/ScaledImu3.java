...
public class ScaledImu3 implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "int16_t", position = 2, typeSize = 2, streamLength = 2, description = "X acceleration", units = "mG")
	private short xacc;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 3, typeSize = 2, streamLength = 2, description = "Y acceleration", units = "mG")
	private short yacc;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 4, typeSize = 2, streamLength = 2, description = "Z acceleration", units = "mG")
	private short zacc;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 5, typeSize = 2, streamLength = 2, description = "Angular speed around X axis", units = "mrad/s")
	private short xgyro;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 6, typeSize = 2, streamLength = 2, description = "Angular speed around Y axis", units = "mrad/s")
	private short ygyro;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 7, typeSize = 2, streamLength = 2, description = "Angular speed around Z axis", units = "mrad/s")
	private short zgyro;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 8, typeSize = 2, streamLength = 2, description = "X Magnetic field", units = "mgauss")
	private short xmag;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 9, typeSize = 2, streamLength = 2, description = "Y Magnetic field", units = "mgauss")
	private short ymag;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 10, typeSize = 2, streamLength = 2, description = "Z Magnetic field", units = "mgauss")
	private short zmag;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 11, typeSize = 2, streamLength = 2, description = "Temperature, 0: IMU does not provide temperature values. If the IMU is at 0C it must send 1 (0.01C).", units = "cdegC")
	...
	public ScaledImu3(long timeBootMs, short xacc, short yacc, short zacc, short xgyro, short ygyro, short zgyro, short xmag, short ymag, short zmag, short temperature) {
	...
	public ScaledImu3(byte[] messagePayload) {
	...
	public void messagePayload(byte[] messagePayload) {
		...
		temperature = byteArray.getInt16(22);
	}
	...
	public byte[] messagePayload() {
		...
		byteArray.putInt16(temperature,22);
	...
	public final ScaledImu3 setTimeBootMs(long timeBootMs) {
		this.timeBootMs = timeBootMs;
		return this;
	}
	...
	public final ScaledImu3 setXacc(short xacc) {
		this.xacc = xacc;
		return this;
	}
	...
	public final ScaledImu3 setYacc(short yacc) {
		this.yacc = yacc;
		return this;
	}
	...
	public final ScaledImu3 setZacc(short zacc) {
		this.zacc = zacc;
		return this;
	}
	...
	public final ScaledImu3 setXgyro(short xgyro) {
		this.xgyro = xgyro;
		return this;
	}
	...
	public final ScaledImu3 setYgyro(short ygyro) {
		this.ygyro = ygyro;
		return this;
	}
	...
	public final ScaledImu3 setZgyro(short zgyro) {
		this.zgyro = zgyro;
		return this;
	}
	...
	public final ScaledImu3 setXmag(short xmag) {
		this.xmag = xmag;
		return this;
	}
	...
	public final ScaledImu3 setYmag(short ymag) {
		this.ymag = ymag;
		return this;
	}
	...
	public final ScaledImu3 setZmag(short zmag) {
		this.zmag = zmag;
		return this;
	}
	...
	public final ScaledImu3 setTemperature(short temperature) {
		this.temperature = temperature;
		return this;
	}
