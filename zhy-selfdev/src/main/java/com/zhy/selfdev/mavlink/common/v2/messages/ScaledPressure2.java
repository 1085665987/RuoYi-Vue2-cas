...
public class ScaledPressure2 implements Message {
	...
	public ScaledPressure2(long timeBootMs, float pressAbs, float pressDiff, short temperature, short temperaturePressDiff) {
	...
	public ScaledPressure2(byte[] messagePayload) {
	...
	public final ScaledPressure2 setTimeBootMs(long timeBootMs) {
		this.timeBootMs = timeBootMs;
		return this;
	}
	...
	public final ScaledPressure2 setPressAbs(float pressAbs) {
		this.pressAbs = pressAbs;
		return this;
	}
	...
	public final ScaledPressure2 setPressDiff(float pressDiff) {
		this.pressDiff = pressDiff;
		return this;
	}
	...
	public final ScaledPressure2 setTemperature(short temperature) {
		this.temperature = temperature;
		return this;
	}
	...
	public final ScaledPressure2 setTemperaturePressDiff(short temperaturePressDiff) {
		this.temperaturePressDiff = temperaturePressDiff;
		return this;
	}
