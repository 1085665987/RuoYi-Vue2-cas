...
public class LoggingData implements Message {
	...
	public LoggingData(short targetSystem, short targetComponent, int sequence, short length, short firstMessageOffset, short[] data) {
	...
	public LoggingData(byte[] messagePayload) {
	...
	public final LoggingData setTargetSystem(short targetSystem) {
		this.targetSystem = targetSystem;
		return this;
	}
	...
	public final LoggingData setTargetComponent(short targetComponent) {
		this.targetComponent = targetComponent;
		return this;
	}
	...
	public final LoggingData setSequence(int sequence) {
		this.sequence = sequence;
		return this;
	}
	...
	public final LoggingData setLength(short length) {
		this.length = length;
		return this;
	}
	...
	public final LoggingData setFirstMessageOffset(short firstMessageOffset) {
		this.firstMessageOffset = firstMessageOffset;
		return this;
	}
	...
	public final LoggingData setData(short[] data) {
		this.data = data;
		return this;
	}
