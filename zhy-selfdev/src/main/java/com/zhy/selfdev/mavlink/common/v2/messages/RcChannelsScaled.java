...
public class RcChannelsScaled implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "int16_t", position = 3, typeSize = 2, streamLength = 2, description = "RC channel 1 value scaled.")
	private short chan1Scaled;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 4, typeSize = 2, streamLength = 2, description = "RC channel 2 value scaled.")
	private short chan2Scaled;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 5, typeSize = 2, streamLength = 2, description = "RC channel 3 value scaled.")
	private short chan3Scaled;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 6, typeSize = 2, streamLength = 2, description = "RC channel 4 value scaled.")
	private short chan4Scaled;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 7, typeSize = 2, streamLength = 2, description = "RC channel 5 value scaled.")
	private short chan5Scaled;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 8, typeSize = 2, streamLength = 2, description = "RC channel 6 value scaled.")
	private short chan6Scaled;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 9, typeSize = 2, streamLength = 2, description = "RC channel 7 value scaled.")
	private short chan7Scaled;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 10, typeSize = 2, streamLength = 2, description = "RC channel 8 value scaled.")
