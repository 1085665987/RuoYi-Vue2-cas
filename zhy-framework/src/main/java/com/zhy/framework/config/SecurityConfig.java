...
import com.zhy.framework.config.properties.CasProperties;
import com.zhy.framework.security.handle.CasAuthenticationSuccessHandler;
import com.zhy.framework.web.service.CasUserDetailsService;
    ...
    protected void configure(HttpSecurity httpSecurity) throws Exception {
        ...
        if (casProperties.isCasEnable()) {
            httpSecurity
                    ...
                    .antMatchers("/DeferredResult").anonymous()
                    .antMatchers("/common/download**").anonymous()
                    .antMatchers("/common/download/resource**").anonymous()
                    .antMatchers("/swagger-ui.html").anonymous()
                    .antMatchers("/swagger-resources/**").anonymous()
