...
@MavlinkEnumMavCmdEntry(value = 30002, name = "MAV_CMD_PAYLOAD_CONTROL_DEPLOY", hasLocation = "false", isDestination = "false", description = "Control the payload deployment.")
public enum MavCmdPayloadControlDeploy {
	 ...
	 */
	@MavlinkEnumMavCmdEntryParam(index = 1, label = "Operation Mode", minValue = 0, maxValue = 101, increment = 1)
	PARAM_1(),
