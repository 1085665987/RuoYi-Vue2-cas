...
@MavlinkEnumMavCmdEntry(value = 31006, name = "MAV_CMD_SPATIAL_USER_2", hasLocation = "true", isDestination = "false", description = "User defined spatial item. Ground Station will not show the Vehicle as flying through this item. Example: ROI item.")
public enum MavCmdSpatialUser2 {
