...
import com.zhy.selfdev.mavlink.common.v2.enums.MavParamType;
...
public class ParamValue implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "uint8_t", position = 3, typeSize = 1, streamLength = 1, description = "Onboard parameter type.", enum0 = MavParamType.class)
