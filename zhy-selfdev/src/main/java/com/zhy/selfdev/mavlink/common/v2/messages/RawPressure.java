...
public class RawPressure implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "int16_t", position = 3, typeSize = 2, streamLength = 2, description = "Differential pressure 1 (raw, 0 if nonexistent)")
	private short pressDiff1;

	@MavlinkMessageParam(mavlinkType = "int16_t", position = 4, typeSize = 2, streamLength = 2, description = "Differential pressure 2 (raw, 0 if nonexistent)")
	...
	public void messagePayload(byte[] messagePayload) {
		...
		pressAbs = byteArray.getInt16(8);
		pressDiff1 = byteArray.getInt16(10);
		pressDiff2 = byteArray.getInt16(12);
		temperature = byteArray.getInt16(14);
	}
	...
	public byte[] messagePayload() {
		...
		byteArray.putInt16(pressAbs,8);
		byteArray.putInt16(pressDiff1,10);
		byteArray.putInt16(pressDiff2,12);
		byteArray.putInt16(temperature,14);
