...
public class ScaledImu implements Message {
	...
	public ScaledImu(long timeBootMs, short xacc, short yacc, short zacc, short xgyro, short ygyro, short zgyro, short xmag, short ymag, short zmag, short temperature) {
	...
	public final ScaledImu setTemperature(short temperature) {
		this.temperature = temperature;
		return this;
	}
