...
import com.zhy.selfdev.mavlink.common.v2.enums.PositionTargetTypemask;
...
public class PositionTargetLocalNed implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "float", position = 4, typeSize = 4, streamLength = 4, description = "X Position in NED frame", units = "m")
	private float x;

	@MavlinkMessageParam(mavlinkType = "float", position = 5, typeSize = 4, streamLength = 4, description = "Y Position in NED frame", units = "m")
	private float y;

	@MavlinkMessageParam(mavlinkType = "float", position = 6, typeSize = 4, streamLength = 4, description = "Z Position in NED frame (note, altitude is negative in NED)", units = "m")
	private float z;
