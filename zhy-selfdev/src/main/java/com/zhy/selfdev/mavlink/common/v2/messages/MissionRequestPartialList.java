...
public class MissionRequestPartialList implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "int16_t", position = 3, typeSize = 2, streamLength = 2, description = "Start index")
	...
	public MissionRequestPartialList(short targetSystem, short targetComponent, short startIndex, short endIndex, short missionType) {
	...
	public final MissionRequestPartialList setMissionType(short missionType) {
		this.missionType = missionType;
		return this;
	}
