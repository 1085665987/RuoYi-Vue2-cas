...
public class LogEntry implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "uint32_t", position = 4, typeSize = 4, streamLength = 4, description = "UTC timestamp of log since 1970, or 0 if not available", units = "s")
	private long timeUtc;

	@MavlinkMessageParam(mavlinkType = "uint32_t", position = 5, typeSize = 4, streamLength = 4, description = "Size of the log (may be approximate)", units = "bytes")
	private long size;
