...
public class GpsRtk implements Message {
	@MavlinkMessageParam(mavlinkType = "uint32_t", position = 1, typeSize = 4, streamLength = 4, description = "Time since boot of last baseline message received in ms.")
	...
	@MavlinkMessageParam(mavlinkType = "uint32_t", position = 4, typeSize = 4, streamLength = 4, description = "GPS Time of Week of last baseline")
	private long tow;
	...
	@MavlinkMessageParam(mavlinkType = "uint8_t", position = 6, typeSize = 1, streamLength = 1, description = "Rate of baseline messages being received by GPS, in HZ")
	...
	@MavlinkMessageParam(mavlinkType = "uint8_t", position = 8, typeSize = 1, streamLength = 1, description = "Coordinate system of baseline. 0 == ECEF, 1 == NED")
	private short baselineCoordsType;

	@MavlinkMessageParam(mavlinkType = "int32_t", position = 9, typeSize = 4, streamLength = 4, description = "Current baseline in ECEF x or NED north component in mm.")
	private int baselineAMm;

	@MavlinkMessageParam(mavlinkType = "int32_t", position = 10, typeSize = 4, streamLength = 4, description = "Current baseline in ECEF y or NED east component in mm.")
	private int baselineBMm;

	@MavlinkMessageParam(mavlinkType = "int32_t", position = 11, typeSize = 4, streamLength = 4, description = "Current baseline in ECEF z or NED down component in mm.")
