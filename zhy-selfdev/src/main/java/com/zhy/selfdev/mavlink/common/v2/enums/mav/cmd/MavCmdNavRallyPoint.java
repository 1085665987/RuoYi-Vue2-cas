...
@MavlinkEnumMavCmdEntry(value = 5100, name = "MAV_CMD_NAV_RALLY_POINT", hasLocation = "true", isDestination = "false", description = "Rally point. You can have multiple rally points defined.")
public enum MavCmdNavRallyPoint {
