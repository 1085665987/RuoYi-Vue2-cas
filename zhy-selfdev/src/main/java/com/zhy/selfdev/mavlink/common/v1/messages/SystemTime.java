...
public class SystemTime implements Message {
	@MavlinkMessageParam(mavlinkType = "uint64_t", position = 1, typeSize = 8, streamLength = 8, description = "Timestamp of the master clock in microseconds since UNIX epoch.")
	private BigInteger timeUnixUsec;

	@MavlinkMessageParam(mavlinkType = "uint32_t", position = 2, typeSize = 4, streamLength = 4, description = "Timestamp of the component clock since boot time in milliseconds.")
