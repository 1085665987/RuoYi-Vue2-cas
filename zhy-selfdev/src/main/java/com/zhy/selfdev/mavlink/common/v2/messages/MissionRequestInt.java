...
public class MissionRequestInt implements Message {
	...
	public MissionRequestInt(short targetSystem, short targetComponent, int seq, short missionType) {
	...
	public MissionRequestInt(byte[] messagePayload) {
	...
	public final MissionRequestInt setTargetSystem(short targetSystem) {
		this.targetSystem = targetSystem;
		return this;
	}
	...
	public final MissionRequestInt setTargetComponent(short targetComponent) {
		this.targetComponent = targetComponent;
		return this;
	}
	...
	public final MissionRequestInt setSeq(int seq) {
		this.seq = seq;
		return this;
	}
	...
	public final MissionRequestInt setMissionType(short missionType) {
		this.missionType = missionType;
		return this;
	}
