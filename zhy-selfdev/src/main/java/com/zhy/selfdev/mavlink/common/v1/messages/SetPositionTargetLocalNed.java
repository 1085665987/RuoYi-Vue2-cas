...
public class SetPositionTargetLocalNed implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "float", position = 6, typeSize = 4, streamLength = 4, description = "X Position in NED frame in meters")
	private float x;

	@MavlinkMessageParam(mavlinkType = "float", position = 7, typeSize = 4, streamLength = 4, description = "Y Position in NED frame in meters")
	private float y;

	@MavlinkMessageParam(mavlinkType = "float", position = 8, typeSize = 4, streamLength = 4, description = "Z Position in NED frame in meters (note, altitude is negative in NED)")
	private float z;
