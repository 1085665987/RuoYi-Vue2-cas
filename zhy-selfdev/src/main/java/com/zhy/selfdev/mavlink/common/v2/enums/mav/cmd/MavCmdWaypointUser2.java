...
@MavlinkEnumMavCmdEntry(value = 31001, name = "MAV_CMD_WAYPOINT_USER_2", hasLocation = "true", isDestination = "true", description = "User defined waypoint item. Ground Station will show the Vehicle as flying through this item.")
public enum MavCmdWaypointUser2 {
