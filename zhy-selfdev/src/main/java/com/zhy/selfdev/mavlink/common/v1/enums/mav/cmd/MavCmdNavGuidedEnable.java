...
@MavlinkEnumMavCmdEntry(value = 92, name = "MAV_CMD_NAV_GUIDED_ENABLE", hasLocation = "null", isDestination = "null", description = "hand control over to an external controller")
