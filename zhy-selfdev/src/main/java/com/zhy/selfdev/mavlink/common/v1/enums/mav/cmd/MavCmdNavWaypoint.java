...
public enum MavCmdNavWaypoint {
	...
	/**
	 * 0 to pass through the WP, if gt 0 radius in meters to pass by WP. Positive value for clockwise orbit, negative value for counter-clockwise orbit. Allows trajectory control.
	 */
