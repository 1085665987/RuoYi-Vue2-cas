...
@MavlinkEnumMavCmdEntry(value = 114, name = "MAV_CMD_CONDITION_DISTANCE", hasLocation = "false", isDestination = "false", description = "Delay mission state machine until within desired distance of next NAV point.")
public enum MavCmdConditionDistance {
