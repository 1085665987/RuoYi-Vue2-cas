...
@MavlinkEnumMavCmdEntry(value = 92, name = "MAV_CMD_NAV_GUIDED_ENABLE", hasLocation = "false", isDestination = "false", description = "hand control over to an external controller")
public enum MavCmdNavGuidedEnable {
