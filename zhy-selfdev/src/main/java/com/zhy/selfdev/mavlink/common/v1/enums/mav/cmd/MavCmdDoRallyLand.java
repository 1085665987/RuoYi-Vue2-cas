...
@MavlinkEnumMavCmdEntry(value = 190, name = "MAV_CMD_DO_RALLY_LAND", hasLocation = "null", isDestination = "null", description = "Mission command to perform a landing from a rally point.")
