...
@MavlinkEnumMavCmdEntry(value = 240, name = "MAV_CMD_DO_LAST", hasLocation = "false", isDestination = "false", description = "NOP - This command is only used to mark the upper limit of the DO commands in the enumeration")
