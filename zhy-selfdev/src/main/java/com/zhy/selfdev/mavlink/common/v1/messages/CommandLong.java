...
import com.zhy.selfdev.mavlink.common.v1.enums.MavCmd;
...
public class CommandLong implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "uint16_t", position = 3, typeSize = 2, streamLength = 2, description = "Command ID, as defined by MAV_CMD enum.", enum0 = MavCmd.class)
	private int command;
	...
	@MavlinkMessageParam(mavlinkType = "float", position = 5, typeSize = 4, streamLength = 4, description = "Parameter 1, as defined by MAV_CMD enum.")
	private float param1;

	@MavlinkMessageParam(mavlinkType = "float", position = 6, typeSize = 4, streamLength = 4, description = "Parameter 2, as defined by MAV_CMD enum.")
	private float param2;

	@MavlinkMessageParam(mavlinkType = "float", position = 7, typeSize = 4, streamLength = 4, description = "Parameter 3, as defined by MAV_CMD enum.")
	private float param3;

	@MavlinkMessageParam(mavlinkType = "float", position = 8, typeSize = 4, streamLength = 4, description = "Parameter 4, as defined by MAV_CMD enum.")
	private float param4;

	@MavlinkMessageParam(mavlinkType = "float", position = 9, typeSize = 4, streamLength = 4, description = "Parameter 5, as defined by MAV_CMD enum.")
	private float param5;

	@MavlinkMessageParam(mavlinkType = "float", position = 10, typeSize = 4, streamLength = 4, description = "Parameter 6, as defined by MAV_CMD enum.")
	private float param6;

	@MavlinkMessageParam(mavlinkType = "float", position = 11, typeSize = 4, streamLength = 4, description = "Parameter 7, as defined by MAV_CMD enum.")
