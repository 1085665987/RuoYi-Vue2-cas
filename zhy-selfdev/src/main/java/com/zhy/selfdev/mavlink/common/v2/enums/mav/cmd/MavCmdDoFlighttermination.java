...
@MavlinkEnumMavCmdEntry(value = 185, name = "MAV_CMD_DO_FLIGHTTERMINATION", hasLocation = "false", isDestination = "false", description = "Terminate flight immediately")
public enum MavCmdDoFlighttermination {

	/**
	 * Flight termination activated if gt 0.5
	 */
	@MavlinkEnumMavCmdEntryParam(index = 1, label = "Terminate", minValue = 0, maxValue = 1, increment = 1)
	PARAM_1(),
