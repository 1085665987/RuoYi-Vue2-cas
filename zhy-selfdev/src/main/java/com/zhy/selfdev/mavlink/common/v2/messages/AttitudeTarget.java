...
public class AttitudeTarget implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "float", position = 4, typeSize = 4, streamLength = 4, description = "Body roll rate", units = "rad/s")
	private float bodyRollRate;

	@MavlinkMessageParam(mavlinkType = "float", position = 5, typeSize = 4, streamLength = 4, description = "Body pitch rate", units = "rad/s")
	private float bodyPitchRate;

	@MavlinkMessageParam(mavlinkType = "float", position = 6, typeSize = 4, streamLength = 4, description = "Body yaw rate", units = "rad/s")
