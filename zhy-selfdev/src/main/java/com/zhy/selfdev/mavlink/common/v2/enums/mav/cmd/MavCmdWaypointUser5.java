...
@MavlinkEnumMavCmdEntry(value = 31004, name = "MAV_CMD_WAYPOINT_USER_5", hasLocation = "true", isDestination = "true", description = "User defined waypoint item. Ground Station will show the Vehicle as flying through this item.")
public enum MavCmdWaypointUser5 {
