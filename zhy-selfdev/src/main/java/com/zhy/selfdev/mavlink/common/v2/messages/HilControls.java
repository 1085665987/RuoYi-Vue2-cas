...
import com.zhy.selfdev.mavlink.common.v2.enums.MavMode;
...
public class HilControls implements Message {
	...
	@MavlinkMessageParam(mavlinkType = "uint8_t", position = 10, typeSize = 1, streamLength = 1, description = "System mode.", enum0 = MavMode.class)
	private short mode;
