...
public class ScaledImu2 implements Message {
	...
	public ScaledImu2(long timeBootMs, short xacc, short yacc, short zacc, short xgyro, short ygyro, short zgyro, short xmag, short ymag, short zmag, short temperature) {
	...
	public final ScaledImu2 setTemperature(short temperature) {
		this.temperature = temperature;
		return this;
	}
