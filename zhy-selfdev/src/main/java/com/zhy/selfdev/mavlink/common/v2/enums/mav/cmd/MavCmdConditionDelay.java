...
@MavlinkEnumMavCmdEntry(value = 112, name = "MAV_CMD_CONDITION_DELAY", hasLocation = "false", isDestination = "false", description = "Delay mission state machine.")
public enum MavCmdConditionDelay {

	/**
	 * Delay
	 */
	@MavlinkEnumMavCmdEntryParam(index = 1, label = "Delay", units = "s", minValue = 0)
	PARAM_1(),
