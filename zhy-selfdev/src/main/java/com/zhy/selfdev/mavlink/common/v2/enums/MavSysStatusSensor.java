...
@MavlinkEnum(name = "MAV_SYS_STATUS_SENSOR", bitmask = "true")
public enum  MavSysStatusSensor {
	 ...
	 */
	@MavlinkEnumEntry(value = 8388608,description = "0x800000 Motors are reversed")
	MAV_SYS_STATUS_REVERSE_MOTOR(),

	/**
	 * 0x1000000 Logging
	 */
	@MavlinkEnumEntry(value = 16777216,description = "0x1000000 Logging")
	MAV_SYS_STATUS_LOGGING(),

	/**
	 * 0x2000000 Battery
	 */
	@MavlinkEnumEntry(value = 33554432,description = "0x2000000 Battery")
	MAV_SYS_STATUS_SENSOR_BATTERY(),

	/**
	 * 0x4000000 Proximity
	 */
	@MavlinkEnumEntry(value = 67108864,description = "0x4000000 Proximity")
	MAV_SYS_STATUS_SENSOR_PROXIMITY(),

	/**
	 * 0x8000000 Satellite Communication
	 */
	@MavlinkEnumEntry(value = 134217728,description = "0x8000000 Satellite Communication")
	MAV_SYS_STATUS_SENSOR_SATCOM(),

	/**
	 * 0x10000000 pre-arm check status. Always healthy when armed
	 */
	@MavlinkEnumEntry(value = 268435456,description = "0x10000000 pre-arm check status. Always healthy when armed")
	MAV_SYS_STATUS_PREARM_CHECK(),

	/**
	 * 0x20000000 Avoidance/collision prevention
	 */
	@MavlinkEnumEntry(value = 536870912,description = "0x20000000 Avoidance/collision prevention")
